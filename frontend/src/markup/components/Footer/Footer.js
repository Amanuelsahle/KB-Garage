    ...
    <footer className="main-footer">
            ...
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">Ethiopia, Shashamene <br /> Abosto, 07</div>
                </div>
              </div>
            </div>
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">Email us : <br /> <a
                    href="mailto:contact.kbgarage@mail.com.com">kbgarage@mail.com.com</a></div>
                </div>
              </div>
            </div>
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="widget widget_links">
                      ...
                      <div className="widget-content">
                        <ul className="list">
                          <li><a href="/service">Performance Upgrade</a></li>
                          <li><a href="/service">Transmission Service</a></li>
                          <li><a href="/service">Break Repair & Service</a></li>
                          <li><a href="/service">Engine Service & Repair</a></li>
                          <li><a href="/service">Trye & Wheels</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
      ...
      <div className="auto-container">
        <div className="footer-bottom">
          <div className="copyright-text">© Copyright <a href="/">KB Garage</a> 2025 . All right reserved.</div>
        </div>
      </div>
    </footer>
  );
